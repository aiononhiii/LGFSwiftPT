...
func lgf_PageLineAnimationShortToLongScrollLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ progress: CGFloat) {
...
func lgf_PageLineAnimationHideShowScrollLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ progress: CGFloat) {
    if progress > 0.5 {
        line.lgfpt_X = selectX
...
func lgf_PageLineAnimationTortoiseDownScrollLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ progress: CGFloat) {
...
func lgf_PageLineAnimationShortToLongClickLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ duration: TimeInterval) {
    line.lgfpt_X = selectX
    line.lgfpt_Width = selectWidth
}

func lgf_PageLineAnimationHideShowClickLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ duration: TimeInterval) {
...
func lgf_PageLineAnimationSmallToBigClickLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ duration: TimeInterval) {
    // 通过关键帧动画配合我给你的 duration，你应该可以实现很多你想要的独有的效果
    UIView.addKeyframe(withRelativeStartTime: 0.0, relativeDuration: 0.5 - (0.0001 / duration)) {
...
func lgf_PageLineAnimationTortoiseDownClickLineAnimationConfig(_ style: LGFFreePTStyle, _ selectX: CGFloat, _ selectWidth: CGFloat, _ unSelectX: CGFloat, _ unSelectWidth: CGFloat, _ unSelectTitle: LGFFreePTTitle, _ selectTitle: LGFFreePTTitle, _ unSelectIndex: Int, _ selectIndex: Int, _ line: LGFFreePTLine, _ duration: TimeInterval) {
    let space = style.lgf_LineBottom + line.lgfpt_Height
    // 通过关键帧动画配合我给你的 duration，你应该可以实现很多你想要的独有的效果
    UIView.addKeyframe(withRelativeStartTime: 0.0, relativeDuration: 0.5 - (0.0001 / duration)) {
...
func lgf_TitleScrollFollowDefultAnimationConfig(_ style: LGFFreePTStyle, _ lgf_TitleButtons: [LGFFreePTTitle], _ unSelectIndex: Int, _ selectIndex: Int, _ duration: TimeInterval) {
...
func lgf_TitleScrollFollowLeftRightAnimationConfig(_ style: LGFFreePTStyle, _ lgf_TitleButtons: [LGFFreePTTitle], _ unSelectIndex: Int, _ selectIndex: Int, _ duration: TimeInterval) {
